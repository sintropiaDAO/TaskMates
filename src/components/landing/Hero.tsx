        ...
        >
          ...
          >
            ...
            <Button
              ...
              className="text-lg px-10 py-7 rounded-xl bg-card text-foreground border-0 shadow-[0_8px_0_-1px_hsl(155_55%_18%),0_18px_28px_-6px_rgba(0,0,0,0.7),inset_0_2px_6px_hsl(0_0%_100%/0.8)] hover:bg-card hover:-translate-y-0.5 active:translate-y-0 transition-transform font-medium"
            >
              {t('heroHaveAccount')}
            </Button>
          </motion.div>
