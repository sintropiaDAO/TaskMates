  ...
  return (
    <div className={cn('flex justify-end mb-4', className)}>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" sideOffset={8} avoidCollisions={false} className="clay bg-card border-0 rounded-2xl p-1.5 min-w-[10rem] z-[1000] !overflow-visible">
          {options.map((opt) => (
            <DropdownMenuItem
              key={opt}
