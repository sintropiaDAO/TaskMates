...
export default function TagDetail() {
  ...
  const actionTabs: { key: ActionTab; label: string; count: number; icon: React.ReactNode }[] = [
    ...
    { key: 'polls', label: language === 'pt' ? 'Opiniões' : 'Opinions', count: relatedPolls.length, icon: <BarChart3 className="w-3.5 h-3.5" /> },
  ];
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-6 pb-24 space-y-6 overflow-x-hidden">
      ...
      >
        ...
        {/* 2. Divider + panel with search, filters, list */}
          ...
          <div className="glass rounded-2xl p-3 space-y-3 animate-fade-in">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                title={language === 'pt' ? 'Alternar entre em aberto e concluídas' : 'Toggle open / completed'}
              >
